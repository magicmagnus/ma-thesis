...
def main(args):
    ...
    for strength in range(len(attack_vals)):
        ...
        for i in tqdm(range(args.num_images)):
            ...
            # decode the images
            if args.method == 'prc':
                reversed_latents_nowm, true_latents_nowm = prc_watermark.get_inversed_latents(img_nowm_attacked, prompt=current_prompt, do_wm=False, seed=i)
                reversed_latents_wm, true_latents_wm = prc_watermark.get_inversed_latents(img_wm_attacked, prompt=current_prompt, do_wm=True, seed=i)
                if i == 0:
                ...
                reversed_latents_nowm, true_latents_nowm  = gs_watermark.get_inversed_latents(img_nowm_attacked, prompt=current_prompt, do_wm=False, seed=i)
                reversed_latents_wm, true_latents_wm = gs_watermark.get_inversed_latents(img_wm_attacked, prompt=current_prompt, do_wm=True, seed=i)
                if i == 0:
                ...
                reversed_latents_nowm, true_latents_nowm = tr_watermark.get_inversed_latents(img_nowm_attacked, prompt=current_prompt, do_wm=False, seed=i)
                reversed_latents_wm, true_latents_wm = tr_watermark.get_inversed_latents(img_wm_attacked, prompt=current_prompt, do_wm=True, seed=i)
                if i == 0:
                ...
                reversed_latents_nowm, true_latents_nowm = rid_watermark.get_inversed_latents(img_nowm_attacked, prompt=current_prompt, do_wm=False, seed=i, pattern_index=args.pattern_index)
                reversed_latents_wm, true_latents_wm = rid_watermark.get_inversed_latents(img_wm_attacked, prompt=current_prompt, do_wm=True, seed=i, pattern_index=args.pattern_index)
                if i == 0:
                ...
                reversed_latents_nowm, true_latents_nowm = grids_watermark.get_inversed_latents(img_nowm_attacked, prompt=current_prompt, do_wm=False, seed=i, pattern_index=args.pattern_index)
                reversed_latents_wm, true_latents_wm = grids_watermark.get_inversed_latents(img_wm_attacked, prompt=current_prompt, do_wm=True, seed=i, pattern_index=args.pattern_index)
                if i == 0:
        ...
        results = {
            ...
            'do_inv_with_prompt': args.do_inv_with_prompt,
        }
...
if __name__ == '__main__':
    ...
    parser.add_argument('--do_inv_with_prompt', action='store_true', help='Set this flag to use prompts for inversion')
