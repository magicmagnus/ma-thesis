...
if method == 'prc':
    ...
    print("Watermark_m: ", watermark_m)
    print("watermark_m shape: ", watermark_m.shape)
...
for i in tqdm(range(test_num)):
    ...
    if nowm:
        ...
        if method == 'prc':
            ...
            shape = (1, 4, 64, 64)
            init_latents, _, _ = tr_get_noise(shape, from_file=tr_key, keys_path='keys/') # generate 
        else:
            raise NotImplementedError
    #
