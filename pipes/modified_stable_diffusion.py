...
class ModifiedStableDiffusionPipeline(StableDiffusionPipeline):
    ...
    #         latents,
    #     )
    #     print(f'\n[forward MOD] latents min/max after prepare_latents (input to unet): {latents.min().item()}, {latents.max().item()}')
    ...
    #     print(f'\n[forward MOD] latents min/max after  denoising loop: {latents.min().item()}, {latents.max().item()}')
               
    #     # 8. Post-processing
    #     image = self.decode_latents(latents)
    #     print(f'\n[forward MOD] image min/max after decode_latents: {image.min().item()}, {image.max().item()}')
